...
function ListarUsuario() {
    const [citas, setUsuarios] = useState([])//cuando es una lista de elementos se usan [] en los parentesis
    useEffect(() => {
                ...
                <tbody className="table-Light">
                    ...
                    {citas.map((cita, i) => (
                        <tr key={cita._id}>
                            ...
                            <td><button type="button" class="btn btn-danger" onClick={() => eliminarUsuario(cita._id)}>Eliminar</button></td>
