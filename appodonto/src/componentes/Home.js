                                ...
                                <div >
                                    <div class="my-card"> <img class="my-card-img" src="img/resina.jpg" />
                                        <div class="my-card-body trainer-card-body">
                                            ...
                                            <Link class=" text-black my-card-btn" to="resina"> <BsHouseDoorFill color="black" size={20} /> &nbsp; Leer más</Link><br></br>
                                ...
                                <div >
                                    <div class="my-card"> <img class="my-card-img" src="img/sonrisa.webp" />
                                        <div class="my-card-body trainer-card-body">
                                            ...
                                            <Link class=" text-black my-card-btn" to="carillas"> <BsHouseDoorFill color="black" size={20} /> &nbsp; Leer más</Link><br></br>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div >
                                    <div class="my-card"> <img class="my-card-img" src="img/ortodoncias.webp" />
                                        <div class="my-card-body trainer-card-body">
                                            ...
                                            <Link class=" text-black my-card-btn" to="ortodoncia"> <BsHouseDoorFill color="black" size={20} /> &nbsp; Leer más</Link><br></br>
                                        </div>
                                    </div>
                                </div>
                            </div>
